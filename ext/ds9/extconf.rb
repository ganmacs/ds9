...
if using_system_libraries?
  ...
  recipe = MiniPortile.new('nghttp2', 'v1.36.0')
  recipe.configure_options = recipe.configure_options + ['--with-pic']

  recipe.files << {
    url: 'https://github.com/nghttp2/nghttp2/releases/download/v1.36.0/nghttp2-1.36.0.tar.gz',
    sha1: '285b48b470fcdf882aad0c2ccb40a19809957793',
  }
  recipe.cook
